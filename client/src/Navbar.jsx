  ...
  return (
    <>
      <Navbar expand="sm" style={{backgroundColor:"#528560",paddingLeft: "10px",color:"white",
                paddingRight: "10px",}}>
        <Container>
          <Navbar.Brand style={{position:"relative", left:"0px",color:"white",textDecoration: "underline",curser: "pointer",hover: "red"}} onClick={() => navigate("/")}>GO-DE</Navbar.Brand>
          <Nav>
            <Nav.Link style={{color:"white",textDecoration: "underline"}} onClick={() => navigate("/people")}>People</Nav.Link>
